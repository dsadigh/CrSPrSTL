...
f0 = env.signal(makedist('Poisson','lambda', 40)); % This is a r.v. signal taking uniform values on [0, 1]
...
d = env.signal(makedist('Poisson', 'lambda', 15), M);
...
env.run(5, 0, 20, 10); % First param = horizon length, second param = t1, third param = t2, fourth param = number of samples
past = env.past;
past.filled(n(3)) % Value of n at t=3