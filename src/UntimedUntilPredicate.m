classdef UntimedUntilPredicate < Predicate
    ...
    methods
        ...
        function C = Tconstraints(self, T, dt, t0, varargin)
            ...
            Tp = binvar(1, numel(T));
            Tq = binvar(1, numel(T));
            C = [self.p.Tconstraints(Tp, dt, t0, varargin{:}) self.q.Tconstraints(Tq, dt, t0, varargin{:})];
            Z = binvar(1, numel(T));
        ...
        function C = Fconstraints(self, F, dt, t0, varargin)
            ...
            Fp = binvar(1, numel(F));
            Fq = binvar(1, numel(F));
            C = [self.p.Fconstraints(Fp, dt, t0, varargin{:}) self.q.Fconstraints(Fq, dt, t0, varargin{:})];
            Z = binvar(1, numel(F));
